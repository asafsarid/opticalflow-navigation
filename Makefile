...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake VIDEO=VIDEO_ACTIVE SONAR=SONAR_ACTIVE -o Makefile Feedback.pro
#############################################################################
...
CXXFLAGS      = -m64 -pipe -DSONAR_ACTIVE -DVIDEO_ACTIVE -DDEFAULT -std=c++11 -O2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
...
Makefile: Feedback.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) VIDEO=VIDEO_ACTIVE SONAR=SONAR_ACTIVE -o Makefile Feedback.pro
